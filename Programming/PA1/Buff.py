...
This Buff class has a method to export all data to byte string to feed into a graphic card.
...
class Buff:
    ...
    def __init__(self, width=0, height=0, color=None):
        ...
        You might need to create your own buff if you plan to draw on a supersampling canvas.
