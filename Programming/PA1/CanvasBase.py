"""
Set up our display pipeline. WxPython is used to solve system compatibility problems. It is mainly focusing on creating a
display window with a canvas. We will let OpenGL draw on it. OpenGL will orthogonal project a 2D plane which has
the exact size as the window on canvas. A texture will be applied to this plane later. Our program will update this
texture with an assigned buff object. This is the main pipeline we draw on a display window. Window resize and mouse
...
class CanvasBase(glcanvas.GLCanvas):
    ...
    methods for public use start with lowercase letter
    ...
    def OnResize(self, event):
        """
        This method handles onresize events.
        """
