...
A class to draw a Displayable Trapezoid which grows along z axis at the orgin point of xy plane
'''
import os
import numpy as np
import string
...
class DisplayableTrapezoid(Displayable):
    ...
    def __init__(self, parent, topEdge, botEdge, height = 0.5, scale=None):
    ...
    def initialize(self):
        ...
        v_l = [
            [-self.botEdge, -self.botEdge, -self.height],
            [self.botEdge, -self.botEdge, -self.height],
            [self.botEdge, self.botEdge, -self.height],
            [- self.botEdge, self.botEdge , -self.height],
