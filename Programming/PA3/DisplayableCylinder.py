...
A class to draw a Displayable Cylinder with disk caps which grows along z axis at the orgin point of xy plane
'''
import os
import numpy as np
import string
...
class DisplayableCylinder(Displayable):
    ...
    def initialize(self):
        ...
        # add a disk bottom
        glu.gluDisk(self.qd,0,self.top_radius,36,18)
        ...
        # add a disk cap
        glu.gluDisk(self.qd,0,self.bot_radius,36,18)
