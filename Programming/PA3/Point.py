...
class Point:
    ...
    def directionEq(self,other):
        a = self.copy().normalize().getCoords()
        b = other.copy().normalize().getCoords()
        return (a[0] - b[0] < 0.00000000000001 and a[1] - b[1] < 0.00000000000001 and a[2] - b[2] < 0.00000000000001)
