...
add a method 'addNormalMap()' to support normal mapping
"""
...
class Component:
    ...
    def draw(self, shaderProg):
        if isinstance(self.displayObj, Displayable):
            ...
            if self.normalMapOn:
                shaderProg.use()
                self.normalMap.bind(shaderProg.getUniformLocation("normalImage"))
            else:
                shaderProg.use()
                self.normalMap.unbind(shaderProg.getUniformLocation("normalImage"))
    ...
    def setNormalMap(self, shaderProg, imgFilePath, normalMapOn=True):
        ...
        self.normalMap.setTextureImage(normal_image)
