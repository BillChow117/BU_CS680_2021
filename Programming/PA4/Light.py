...
add some variables to support all required features
"""
...
class Light:
    ...
    def __init__(self, position=None, color=None, infiniteDirection=None, spotDirection=None, spotRadialFactor=None, spotAngularFactor=2, spotAngleLimit=30):
        self.ambientON = True
        self.diffuseON = True
        ...
        self.setSpotAngularFactor(spotAngularFactor)
    ...
    def setSpotAngularFactor(self,spotAngularFactor):
        if type(spotAngularFactor) != (int):
            raise TypeError("spotAngularFactor must be a int")
